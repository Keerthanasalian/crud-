...
<i class="fa fa-times" id="cancle"></i>
  ...
  <div class="sidebar">
<header><img src="image/profile2.jpg">
     ...
     $desti=$_POST['Your_destination'];
       ...
       if($conn->connect_error)
          ...
          else
          {
              ...
              $stmt=$conn->prepare("INSERT INTO booking(passenger_name,telephone,email,board_place,Your_destination) VALUES(?,?,?,?,?)");
    ...
    <form action="#" method="POST">
      <div class="form_wrap">
        ...
        <div class="input_wrap">
          ...
          <input type="text" id="title" name="board_place"  placeholder="board"required>
        </div>
