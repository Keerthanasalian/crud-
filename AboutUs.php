...
table
{
    ...
    text-align:center;
    margin-top:50px;
    background-color:black; /*rgb(255, 255, 255); */
    opacity: 0.6;
...
.topic_bus{
  ...
  <body>
        ...
        <div class="about-intro">
            ...
            <p>We, TravelHive (Pvt) Ltd. who is pioneer of Online Bus Ticket Booking Service in India. In this segment the company has launch a web site www.TravelHive.LK with the collaboration of registered Busses in Karnataka.</p>
        </div>
    </div>
...
?>
        ...
        <div class="about-intro">
            ...
            <p>Plan your journey ahead of time, save time buying bus tickets, avoid lengthy lines, discover your boarding location quickly, and enjoy your joyous journey in comfort using TravelHive's efficient bus reservation system
            </p>
